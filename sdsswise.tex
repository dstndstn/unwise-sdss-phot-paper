...
% -DiPompeo et al?
%
% -ApJ reference for Chen & Wright
% -''patching'' -- show mag-difference histogram with patching & with
%   patching-from-the-coadd?; & update response-to-referee.
%

% To-do: say something clever for @OverheardOnAph.  @dstndstn @davidwhogg I see what you did there #soMeta
...
\bibitem[Chen \etal(2007)]{chen}
Chen,~X. and Wright,~E.~L., 2007, \apj XXX, XXX; \arxiv{0712.3594}
