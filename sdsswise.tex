...
approximation radius \emph{before} we have measured the flux.  We
therefore need a rough estimate of the WISE flux of each SDSS source.
We do this by matching to the WISE catalog with a radius of 4
arcseconds, and (conservatively) summing the fluxes of all nearby WISE
sources as our estimate of the flux of each SDSS source for PSF
